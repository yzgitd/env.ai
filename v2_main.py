                ...
                if len(det):
                    ...
                    for *xyxy, conf, cls in reversed(det):
                        ...
                        if save_img or save_crop or view_img:  # Add bbox to image
                            ...
                            print(names[int(cls)])
                            classess = ''
                            if names[int(cls)] == ' tea' or names[int(cls)] == ' bone' or names[int(cls)] == ' leftovers':
                                classess = 'Kitchen Waste-'
                            if names[int(cls)] == ' newspaper' or names[int(cls)] == ' power Bank' or names[int(cls)] == ' flyer':
                                classess = 'Recyclable waste-'
                            if names[int(cls)] == ' cosmetic' or names[int(cls)] == ' tableware':
                                classess = 'Other Waste-'
                            if names[int(cls)] == ' Battery' or names[int(cls)] == ' Light bulb' or names[int(cls)] == ' thermometer' or names[int(cls)] == ' dry battery' or names[int(cls)] == ' ointment' or names[int(cls)] == ' Insecticide':
                                classess = 'Harmful Waste-'

                            label = classess + names[int(c)]
                            ...
                            try:
                                ...
                                ui.printf('检测到 ' + label + '坐标为:(' + str(xx) + ',' + str(yy) + ')')
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-image: url(\"./images/main02.png\")")
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(168, 60, 491, 71))
        self.label.setAutoFillBackground(False)
        self.label.setStyleSheet("人工智能环保系统")
        self.label.setFrameShadow(QtWidgets.QFrame.Plain)
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.label.setStyleSheet("font-size:50px;font-weight:bold;font-family:SimHei;color: white ;background:rgba(255,255,255,0);")
        # self.label.setStyleSheet("font-size:50px;font-weight:bold;font-family:SimHei;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "人工智能环保系统"))
        self.label.setText(_translate("MainWindow", "人工智能环保系统"))
        self.label_2.setText(_translate("MainWindow", ""))
        self.pushButton.setText(_translate("MainWindow", "uoload file"))
        self.pushButton_2.setText(_translate("MainWindow", "real ai"))
        self.pushButton_3.setText(_translate("MainWindow", "stop ai"))
    ...
    def openfile(self):
        ...
        ui.printf("file path：%s" % filepath)
